...
public class Solution {
    public static void main(String[] args) {
        JuniorJavaDev me = JuniorJavaDev.createJuniorJavaDev();
    ...
    public static final class JuniorJavaDev extends JavaDev {
        JavaDev zapp = new JavaDev();
        JavaDev hubert = new JavaDev();

        private JuniorJavaDev() {
        }

        public static JuniorJavaDev createJuniorJavaDev() {
            return new JuniorJavaDev();
        }
